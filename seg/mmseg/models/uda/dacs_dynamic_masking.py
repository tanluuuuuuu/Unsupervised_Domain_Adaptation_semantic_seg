...
from mmseg.models.uda.dynamic_masking_consistency_module import (
    DynamicMaskingConsistencyModule,
)
...
@UDA.register_module()
class DACS_Dynamic_Masking(UDADecorator):

    def __init__(self, **cfg):
        super(DACS_Dynamic_Masking, self).__init__(**cfg)
        self.local_iter = 0
