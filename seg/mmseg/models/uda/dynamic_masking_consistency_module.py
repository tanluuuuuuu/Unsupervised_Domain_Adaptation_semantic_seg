...
class DynamicMaskingConsistencyModule(Module):

    def __init__(self, require_teacher, cfg):
        super(DynamicMaskingConsistencyModule, self).__init__()
    ...
    def __call__(self,
        ...
        masked_img = self.mask_gen.mask_image(masked_img, mask_ratio)
